...
export function columns() {
  let colsList = [
    ...
    { title: '组件版本', width: 150, dataIndex: 'version', myNoWrap: true, mySort: true },
    { title: '文件路径', width: 200, dataIndex: 'file_path', myNoWrap: true, mySort: true },
    { title: '固件名称', width: 250, dataIndex: 'fw_name', myNoWrap: true, mySort: true },
    { title: '关联漏洞编号', width: 200, dataIndex: 'edb_id', mySort: true },
